...
urlpatterns = [
    ...
    path("media-health/", admin_media_health_view, name="admin_media_health"),
    ...
    path(
        "blogs/<int:pk>/gallery/<int:image_id>/delete/",
        admin_blog_gallery_delete_view,
        name="admin_blog_gallery_delete",
    ),
