...
urlpatterns = [
    ...
    path(
        ...
        name="blog-detail-by-id",
    ),
    path(
        "blogs/<slug:slug>/",
        BlogViewSet.as_view({"get": "retrieve_by_slug"}),
    ...
    path(
        "categories/",
        BlogCategoryViewSet.as_view({"get": "list"}),
    ...
    path(
        "admin/blogs/",
        BlogAdminViewSet.as_view({"get": "list"}),
        name="blog-admin-list",
    ),
    path("licenses/download/", download_license_csv),
